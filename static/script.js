...
// // ===== Fullscreen & Anti-Tab Switch Vars =====
...
//   if (testRunning && document.hidden) {
//     handleTabSwitch();
//   }
// }
...
//   tabSwitchCount++;
//   toast(`Warning! Tab switch detected (${tabSwitchCount}/${maxTabSwitches})`);
//   log(`Warning! Tab switch detected (${tabSwitchCount}/${maxTabSwitches})`);

//   if (tabSwitchCount > maxTabSwitches) {
//     toast("Test terminated due to multiple tab switches!");
//     log("Test terminated due to multiple tab switches!");
//     endTest();
//   }
// }
...
// startBtn.onclick = async () => {
//   startBtn.disabled = true;
//   startTestLock(); // 🔹 Lock screen & start detection
//   await setupCamera();
...
//       await stopRecordingAndUpload();
//       try { ws.close(); } catch {}
//       endTest(); // 🔹 Exit fullscreen at the end
//     }
//     else if (payload.type === "error") {
//       toast("Error: " + payload.message);
//       log("Error: " + payload.message);
...
function startTestLock() {
  ...
  document.addEventListener("fullscreenchange", () => {
    if (testRunning && !document.fullscreenElement) {
  ...
  document.addEventListener("visibilitychange", () => {
    if (testRunning && document.hidden) {
      handleViolation("Tab switch or minimize detected");
    }
  });
